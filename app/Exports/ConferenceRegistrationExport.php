...
class ConferenceRegistrationExport implements FromCollection, WithHeadings, ShouldAutoSize
{
    ...
    {
        if ($this->type == 'all') {
            return ["S.No.", "Name", "Member Type", "Email", "Phone", "Medical Council Number", "No. of People", "Verification Status", "Country", "Participant Type"];
        } else {
            return ["S.No.", "Name", "Member Type", "Email", "Phone", "Medical Council Number", "No. of People", "Verification Status", "Country"];
        }
    }
}
