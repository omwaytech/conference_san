                                ...
                                @foreach ($sponsors as $sponsor)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-sm btn-primary addParticipant"
                                                data-id="{{ $sponsor->id }}" data-toggle="modal"
                                                data-target="#openModal">Add Participant's Number</button>
                                        </td>
                                        <td>
                                            <form action="{{ route('sponsor.destroy', $sponsor->id) }}" method="POST">
                                                @method('delete')
                                                @csrf
                                                <a href="{{ route('sponsor.edit', $sponsor->id) }}" class="btn btn-success"
                                                    title="Edit Data"><i class="nav-icon i-Pen-2"></i></a>
                                                <button class="btn btn-info" type="button" data-toggle="modal"
                                                    data-target="#modal{{ $sponsor->id }}"><i
                                                        class="nav-icon i-Eye"></i></button>
                                                <button title="Delete Data" class="btn btn-danger delete" type="submit"><i
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-4 mb-4">
                                                            <p class="text-primary mb-1"><i
                                                                    class="i-ID-2 text-16 mr-1"></i>Sponsor Category</p>
                                                            <span>{{ $sponsor->category->category_name }}</span>
                                                        </div>
                                                        <div class="col-md-4 mb-4">
                                                            <p class="text-primary mb-1"><i
                                                                    class="i-ID-2 text-16 mr-1"></i>Name</p>
                                                            <span>{{ $sponsor->name }}</span>
                                                        </div>
                                                        <div class="col-md-4 mb-4">
                                                            <p class="text-primary mb-1"><i
                                                                    class="i-ID-2 text-16 mr-1"></i>Amount</p>
                                                            <span>{{ $sponsor->amount }}</span>
                                                        </div>
                                                        @if (!empty($sponsor->logo))
                                                            <div class="col-md-4 mb-4">
                                                                <p class="text-primary mb-1"><i
                                                                        class="i-ID-2 text-16 mr-1"></i>Logo</p><span><img
                                                        ...
                                                        @if (!empty($sponsor->address))
                                                            <div class="col-md-4 mb-4">
                                                                <p class="text-primary mb-1"><i
                                                                        class="i-ID-2 text-16 mr-1"></i>Address</p>
                                                        ...
                                                        @if (!empty($sponsor->contact_person))
                                                            <div class="col-md-4 mb-4">
                                                                <p class="text-primary mb-1"><i
                                                                        class="i-ID-2 text-16 mr-1"></i>Contact Person</p>
                                                        ...
                                                        @if (!empty($sponsor->email))
                                                            <div class="col-md-4 mb-4">
                                                                <p class="text-primary mb-1"><i
                                                                        class="i-ID-2 text-16 mr-1"></i>Email</p>
                                                                <span>{{ $sponsor->email }}</span>
                                                            </div>
                                                        @endif
                                                        <div class="col-md-4 mb-4">
                                                            <p class="text-primary mb-1"><i
                                                                    class="i-ID-2 text-16 mr-1"></i>Phone</p>
