...
<body>
    ...
    <div class="container_content" id="container_content">
        {{-- <table width="1410" border="0" cellspacing="0" cellpadding="0"
            style="font-size:18px; background:url('{{ asset('certificate/deafult/Frame-NESOG.jpg') }}') no-repeat center top; background-size:99%; ">
                ...
                <td>
                    <table width="1698" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <td width="350">&nbsp;</td>
                            <td width="440">
                                <img src="{{ asset('certificate/deafult/NESOG.png') }}" width="180" alt="" />
                            </td>
                ...
                <td>
                    ...
                    <table width="1698" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td width="700">
                                <h1
                                    style="text-transform:uppercase; font-size:40px; background-color:#364c99; width:auto; height:45px; line-height:50px; padding:10px 0px; margin:5px 0px; overflow:hidden; color:#fff;">
                ...
                <td>
                    <table width="1698" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            <td width="260">&nbsp;</td>
                            <td width="1210">
                                <h1 style="line-height:55px; margin-bottom:20px;">for your valuable contribution in the
                                    <br />
                                    <small><b style="font-size:48px; margin:10px 0px; color:#e5a356;">XVII International
                        ...
                        <tr>
                            ...
                            <td width="1210">
                                <h1
                                    ...
                                    NESOGCON 2025<br />
                                    <small style="font-size:26px;color:#000;">"Innovation and Equity in Women’s Health:
            ...
            <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding:0px 15px 0px 15px; text-align:center;">
                                <table border="0" width="300" cellspacing="0" cellpadding="0">
                                    <tr>
                                    <tr>
                                        <td width="260"><img src="{{ asset('certificate/deafult/sapana.png') }}"
                ...
                <td style="padding:0px 15px 0px 15px; text-align:center;">
                    <table border="0" width="250" cellspacing="0" cellpadding="0">
                        <tr>
                            <td width="260"><img src="{{ asset('certificate/deafult/neeva.png') }}" alt=""
                    ...
                    <table width="1698" border="0" cellspacing="0" cellpadding="0"
                        ...
                        <tr>
                            ...
                            <td width="780">
                                <h6 style="font-size:40px; margin:0px; padding:10px 0px;">to</h6>
                                @php
                                    $wordCount = str_word_count($sponsor->name);
                                @endphp
                                @if ($wordCount > 5)
                                    <h3 style="font-weight:500; font-size:72px; margin-bottom:15px; color:#e5a356;">
                                        {{ $sponsor->name }}</h3>
                                @else
                                    <h3 style="font-weight:500; font-size:80px; margin-bottom:15px; color:#e5a356;">
                                        {{ $sponsor->name }}</h3>
