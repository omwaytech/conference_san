<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTitle">Add Participants <span class="text-danger">(Sponsor Name: {{$sponsor->name}})</span></h5>
    ...
    <form id="verifyForm">
        ...
        <div class="row">
            ...
            <div class="col-md-6 form-group mb-3">
                ...
                <input type="number" name="additional_value" id="additional_value" class="form-control @error('additional_value') is-invalid @enderror">
