        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-12">
                    <div class="card mb-4">
                        @php
                            $fonePayPayment = session()->get('fonePay');
                            // dd($fonePayPayment);
                        @endphp
                        <div class="card-body">
                            <form action="{{ route('conference-registration.submit') }}" method="POST"
                                ...
                                <input type="hidden" name="registrant_type"
                                    value="{{ $fonePayPayment['registrant_type'] }}">
                                <input type="hidden" name="accompany_person"
                                    value="{{ $fonePayPayment['accompany_person'] }}">
                                <div class="row">
                                    ...
                                    @if ($fonePayPayment['registrant_type'] == 2)
                                    ...
                                    @endif
                                    @if (!empty($fonePayPayment['accompany_person']))
                                        <div class="col-12">
                                            <h5>Accompany Persons Detail
                                                <code>({{ $fonePayPayment['accompany_person'] }})</code>: </h5>
                                        </div>
                                        @for ($i = 0; $i < $fonePayPayment['accompany_person']; $i++)
