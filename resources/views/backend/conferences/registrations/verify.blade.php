<div class="modal-header">
    <h5 class="modal-title" id="exampleModalCenterTitle">Verify Registrant <span class="text-danger">(Registrant Name: {{$registration->user->fullName($registration, 'user')}})</span></h5>
...
<script>
    ...
    $("#verifyRegistrant").on('click', function (e) {
        ...
        $.ajax({
            type: "POST",
            url: '{{route('conferenceRegistration.verifyRegistrant')}}',
            data: data,
            dataType: "json",
            processData: false,
            contentType: false,
