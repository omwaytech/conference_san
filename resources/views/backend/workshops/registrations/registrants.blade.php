            ...
            <div class="card text-left">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="ml-auto">
                            <a href="{{ route('workshop-registration.generatePass', $workshop->id) }}"
                                class="btn btn-primary ml-2" target="_blank"><i class="nav-icon i-File"></i> Generate Pass</a>
                            ...
                            <tbody>
                                @foreach ($registrations as $registration)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                @if ($registration->workshop->user_id == auth()->user()->id || auth()->user()->role == 2)
                                                    <a href="#" class="verifyRegistrant"
                                                        data-id="{{ $registration->id }}" data-toggle="modal"
                                        ...
                                        <td>
                                            @if ($registration->verified_status == 1)
                                                <a href="{{ route('workshop-registration.generateIndividualPass', $registration->id) }}"
