                                ...
                                <td width="1200">
                                    <h1
                                        ...
                                        <small>Of</small><br /> <span style="color:#254d9e;">Nepal Society of
                                            Obstetricians and Gynaecologists (NESOG)</span><br />
                                        <i style="font-weight:400; font-size:38px; padding:10px 0px;">"Advances in
                                            Women's Health Care Now & Beyond"</i>
                                    </h1>
                                </td>
                                <td width="155">&nbsp;</td>
                            </tr>
                    ...
                    <td>
                        <table width="1698" border="0" cellspacing="0" cellpadding="0"
                            ...
                            <tr>
                                <td width="260">&nbsp;</td>
                                <td width="1210">
                                    <h1 style="line-height:60px; margin-bottom:0px;">for her participation in the <br />
                                        <small><b style="font-size:60px; margin:10px 0px; color:#e5a356;">
                                            @if ($participant->workshop_id == 3)
                                                Colposcopy Workshop </b> <br />3<sup>rd</sup>
                                            @endif
                                            April, 2024, Kathmandu, Nepal</small>
                                    </h1>
                                    ...
                                    <table width="310" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td width="260" height="100"><img
                                                    src="{{ asset('certificate/saroja.png') }}"
                                                    alt="" style="height:85px;" /></td>
                                        </tr>
                                        <tr>
                                ...
                                <td style="padding:0px 150px 0px 25px; text-align:center;">
                                    @if ($participant->workshop_id == 3)
                                        <table border="0" width="320" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="260" height="100"><img
                                                        src="{{ asset('certificate/urogynaecology/jitendra.png') }}"
                                                        alt="" style="height:100px;" /></td>
                                            </tr>
                                            <tr>
                                                <td width="260" style="border-bottom:#000 2px dotted;">&nbsp;</td>
